...
class ActionHistory(models.Model):
    ...
    policy = models.OneToOneField(ActionPolicy, related_name="audit_policy", on_delete=models.PROTECT)

    executed = models.NullBooleanField(default=False, null=True)

    executed_time = models.DateTimeField(default=None, null=True)

    application = models.ForeignKey(Application, related_name="action_history_application", on_delete=models.PROTECT)
